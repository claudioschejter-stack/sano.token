...
export const es = {
  ...
  dashboard: {
    ...
    kpiTotalPortfolio: 'Valor total cartera',
    kpiTotalPortfolioHint: 'Tokens RWA + stablecoins + fiat, moneda base USD',
    portfolioEvolutionTitle: 'Evolución de cartera',
    portfolioEvolutionSubtitle: 'Valor total en moneda base USD',
