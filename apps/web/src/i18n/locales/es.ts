...
export const es = {
  ...
  adminTeam: {
    designateTitle: 'Designar asesor',
    designateDesc: 'El administrador asigna gerentes de asesores y asesores en la red.',
    email: 'Email',
    name: 'Nombre',
    role: 'Rol',
    roleAdvisor: 'Asesor',
    roleManager: 'Gerente de asesores',
    upline: 'Reporta a (gerente)',
    selectUpline: 'Seleccionar gerente…',
    designate: 'Designar',
    designating: 'Designando…',
    designateSuccess: 'Asesor designado correctamente.',
    designateError: 'No se pudo designar el asesor.',
    advisorsTitle: 'Red de asesores',
    membersTitle: 'Equipo y verificación KYC',
    membersDesc:
      'Datos de identidad (Didit), correo y teléfono verificados para todos los roles de la plataforma.',
    ...
    empty: 'No hay asesores designados.',
    emptyMembers: 'No hay usuarios registrados.',
    nominationsTitle: 'Solicitudes de asesores',
    nominationsDesc: 'Los asesores sugieren incorporaciones; el administrador aprueba o rechaza.',
    colSuggestedBy: 'Sugerido por',
    colStatus: 'Estado',
    colDate: 'Fecha',
    approve: 'Aprobar',
    reject: 'Rechazar',
    ...
    approved: 'Aprobado',
    rejected: 'Rechazado',
    noNominations: 'No hay solicitudes pendientes.',
    refresh: 'Actualizar'
  },
  adminSettings: {
  ...
  onboarding: {
    ...
    steps: {
      ...
      diditRedirectingHint: 'DNI o pasaporte y prueba de vida en tu celular.',
