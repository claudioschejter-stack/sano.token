...
export const es = {
  ...
  adminLaunch: {
    ...
    centrifugeDesc: 'Requisitos previos para registrar el activo en Centrifuge / Tinlake.',
    ...
    noFile: 'Sin archivo',
    uploadPdf: 'Subir PDF',
    collateralDesc: 'Seleccioná los protocolos de crédito donde registrar el token como colateral. La plataforma valida requisitos y envía automáticamente cuando están configuradas las credenciales.',
    ...
    tokenDeployDesc: 'Sanova KYC o ERC-4626 vía contratos propios (ethers + wallet con gas en Base Sepolia). Thirdweb solo para demos. Requiere TOKEN_DEPLOY_PRIVATE_KEY o PRIVATE_KEY.',
    deployToken: 'Emitir token',
    autoDeployOnCreate: 'Solicitar emisión automática al crear',
    tokenStatus: 'Estado',
