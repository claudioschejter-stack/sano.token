...
export const es = {
  ...
  adminWithdrawals: {
    ...
    title: 'Retiros',
    subtitle:
      'Los retiros descuentan el saldo interno del inversor de inmediato. Enviá el USDC desde el Safe de tesorería fuera de esta app y confirmá acá con el hash de la transacción, o rechazá para devolver el saldo.',
  ...
  platformWallet: {
    ...
    withdrawAutoSubtitle: 'Tu solicitud de retiro se descuenta del saldo y queda en revisión; el equipo envía el USDC a tu wallet vinculada en las próximas horas.',
    withdrawAutoRunning: 'Enviando solicitud de retiro…',
    withdrawAutoHint: 'Al confirmar, reservamos el saldo y procesamos el envío del USDC a tu wallet.',
