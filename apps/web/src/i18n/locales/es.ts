...
export const es = {
  ...
  landing: {
    ...
    hero: {
      ...
      subtitle:
        'Sanova Global conecta inversores verificados con propiedades productivas en Vaca Muerta, Argentina — Epicentro global del shale oil & gas no convencional, con la segunda reserva de gas del planeta, infraestructura de clase mundial, costos operativos entre los más competitivos y un enorme potencial de producción petrolera y gasífera — además de rendimientos transparentes, cumplimiento KYC y liquidación instantánea.',
      subtitleLead:
        'Sanova Global conecta inversores verificados con propiedades productivas en Vaca Muerta, Argentina —',
      subtitleHighlight:
        'Epicentro global del shale oil & gas no convencional, con la segunda reserva de gas del planeta, infraestructura de clase mundial, costos operativos entre los más competitivos y un enorme potencial de producción petrolera y gasífera.',
      subtitleClose:
        '— además de rendimientos transparentes, cumplimiento KYC y liquidación instantánea.',
