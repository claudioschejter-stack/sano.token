...
export const es = {
  ...
  simplifiedCheckout: {
    ...
    cryptoWalletPaymentReceivedBody: 'Detectamos tu transferencia en Base automáticamente.',
    ...
    cryptoWalletInsufficientPrivy:
      'No hay USDC suficiente en tu wallet Sanova. Transferí USDC Base a la dirección de arriba (tu wallet Privy), no a la dirección treasury, y volvé a pagar.',
    cryptoWalletPrivyPayError: 'No se pudo pagar con Privy: {error}',
    cryptoWalletOtherWalletTitle: 'Otra wallet / transferencia externa (avanzado)',
    cryptoWalletOtherWalletHint:
      'Solo si ya tenés MetaMask u otra app. Si mandás desde Ripio u exchange, enviá a TU wallet Sanova (Privy), no copies la treasury salvo que estés siguiendo el monto exacto de seguimiento.',
