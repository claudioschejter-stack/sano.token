...
export const es = {
  ...
  legalPagesMeta: {
    termsTitle: 'Términos Legales | Sanova Global',
    termsDescription:
    ...
    privacyTitle: 'Política de Privacidad | Sanova Global',
    privacyDescription:
    ...
    totpVerifyTitle: 'Verificación de seguridad — Sanova Capital',
    securityTitle: 'Seguridad — Sanova Capital',
    securityDescription: 'Configura la autenticación de dos factores (2FA) para proteger tu cuenta.'
  },
  brand: {
  ...
  marketplace: {
    ...
    publishPropertyCta:
      'Si quieres publicar tu propiedad en este sitio de compra venta de inmuebles tokenizados, click aqui y nos comunicamos contigo',
  ...
  adminWithdrawals: {
    eyebrow: 'Cumplimiento de retiros',
    title: 'Retiros',
    subtitle:
      'Los retiros descuentan el saldo interno del inversor de inmediato. Para USDC, enviá desde el Safe de tesorería y confirmá con el hash. Para pesos/fiat, ejecutá la transferencia bancaria y confirmá con la referencia — o rechazá para devolver el saldo.',
    loading: 'Cargando retiros…',
    error: 'No se pudieron cargar los retiros.',
    refresh: 'Actualizar',
    kpiPending: 'Monto pendiente',
    kpiPendingHint: '{count} solicitud(es) esperando cumplimiento',
    kpiOldest: 'Solicitud pendiente más antigua',
    kpiOldestHint: 'Tiempo esperando cumplimiento',
    filters: {
      ALL: 'Todos',
      PENDING: 'Pendientes',
    ...
    colStatus: 'Estado',
    colActions: 'Acciones',
    emptyState: 'No hay retiros con este filtro.',
    ...
    confirmSubmitting: 'Confirmando…',
    rejectFormTitle: 'Rechazar retiro',
    rejectFormHint: 'El saldo se acreditará automáticamente de nuevo al inversor.',
    reasonPlaceholder: 'Motivo (se muestra al inversor)',
    rejectSubmit: 'Rechazar y devolver saldo',
    rejectSubmitting: 'Rechazando…',
    verificationOk: 'Transferencia verificada on-chain ({confirmations} confirmación(es)).',
    verificationWarning:
      'No se pudo verificar la transferencia on-chain ({reason}). Revisá el hash antes de confiar en esta confirmación.',
    methodStablecoin: 'USDC',
  ...
  cartCheckout: {
    ...
    paymentMethods: {
      ...
      coinbase_commerce: 'Tarjeta de débito, crédito y transferencia',
      binance_pay: 'Binance Pay',
      ripio_on_ramp: 'Billetera electrónica',
      modo: 'Modo',
      ...
      arq: 'ARQ',
      astropay: 'AstroPay',
      local_transfer: 'Transferencia bancaria (AR)',
      nubank: 'Nubank',
      pix: 'Pix (Brasil)',
      lemon: 'Lemon',
      ripio: 'Ripio Wallet',
      ...
      phonepe: 'PhonePe',
      wise: 'Wise',
      bridge: 'Tarjeta de débito, crédito y transferencia',
      ach: 'ACH (EE.UU.)',
      sepa: 'SEPA (Europa)',
      transak: 'Tarjeta de débito, crédito y transferencia',
      ramp: 'Ramp Network',
      privy_on_ramp: 'Tarjeta / Apple Pay (Privy)',
  ...
  linkedWallets: {
    ...
    subtitle: 'Wallets cripto y billeteras digitales que usaste alguna vez para pagar o cobrar en Sanova.',
    cryptoSection: 'Wallets cripto (USDC en Base)',
    fiatSection: 'Billeteras digitales (pesos)',
    bridgeSection: 'Cuentas bancarias (Bridge)',
    bridgeProvider: 'Bridge',
    bridgeAddCta: 'Vincular cuenta bancaria (USD / EUR / MXN)',
    bridgeLinkTitle: 'Vincular cuenta bancaria con Bridge',
    bridgeLinkDesc:
      'Agregá tu cuenta de EE.UU. (ACH), UE (IBAN) o México (CLABE) para retiros fiat. Sanova sigue revisando los pagos manualmente.',
    bridgeCurrency: 'Moneda',
    bridgeBankName: 'Nombre del banco',
    bridgeAccountName: 'Nombre de la cuenta',
    bridgeFirstName: 'Nombre',
    bridgeLastName: 'Apellido',
    bridgeOwnerName: 'Titular de la cuenta (opcional)',
    bridgeRouting: 'Routing number',
    bridgeAccountNumber: 'Número de cuenta',
    bridgeIbanCountry: 'País del IBAN (ISO)',
    bridgeStreet: 'Dirección',
    bridgeCity: 'Ciudad',
    bridgeState: 'Estado / provincia',
    bridgePostal: 'Código postal',
    bridgeCountry: 'País (ISO)',
    bridgeLinkCta: 'Guardar cuenta bancaria',
    bridgeLinking: 'Guardando…',
    bridgeLinkError: 'No se pudo vincular la cuenta. Revisá los datos e intentá de nuevo.',
    bridgeKycRequired: 'Completá el KYC y los Términos de Bridge antes de vincular una cuenta bancaria.',
    bridgeKycCta: 'Continuar KYC',
    bridgeTosCta: 'Aceptar términos',
    defaultBadge: 'Activa',
    useThisWallet: 'Usar esta wallet',
    switching: 'Activando…',
    hint: 'Al retirar, vas a poder elegir a cuál de estas wallets enviar el producido de tus ventas.'
  },
  platformWallet: {
    ...
    depositTitle: 'Depositar fondos',
    depositSubtitle: 'Enviá USDC Base a tu wallet Sanova. El saldo se actualiza solo.',
    receiveUsdcTitle: 'Recibir USDC (Base)',
    receiveUsdcSubtitle:
    ...
    receiveUsdcCopied: 'Dirección copiada',
    receiveUsdcNoWallet: 'Estamos preparando tu wallet Sanova. Recargá en unos segundos.',
    receiveUsdcNetwork: 'Red: Base · Token: USDC',
    receiveUsdcInvestCta: 'Invertir con este saldo',
    withdrawTitle: 'Retirar fondos',
    withdrawSubtitle: 'USDC a tu wallet conectada o retiro fiat con revisión de tesorería.',
    withdrawAutoSubtitle: 'Elegí si querés retirar en USDC a una wallet cripto vinculada o en pesos con revisión de tesorería.',
    withdrawAutoRunning: 'Enviando solicitud de retiro…',
    withdrawAutoHint: 'Al confirmar, reservamos el saldo y procesamos el envío a destino.',
    withdrawModeCrypto: 'USDC a mi wallet',
    withdrawModeFiat: 'Pesos (transferencia)',
    withdrawSubmitCrypto: 'Retirar USDC ahora',
    withdrawSubmitFiat: 'Solicitar retiro en pesos',
    fiatChipsLabel: 'Billeteras que ya usaste para pagar',
    fiatChipNoteTemplate: 'Cuenta usada previamente para pagar: {identifier}',
    fiatRailBank: 'Banco / CBU-CVU',
    fiatRailOther: 'Otro medio',
    fiatAccountHolder: 'Titular de la cuenta',
    fiatTaxId: 'CUIT / DNI',
    fiatCbuCvu: 'CBU / CVU',
    fiatAlias: 'Alias',
    fiatProviderName: 'Billetera / banco (opcional)',
    fiatNotes: 'Indicanos cómo recibir el pago',
    fiatManualHint: 'Un administrador de Sanova revisa y ejecuta la transferencia manualmente; te va a llegar un email cuando esté confirmada.',
    fiatFormIncomplete: 'Completá los datos obligatorios para solicitar el retiro en pesos.',
  ...
  access: {
    ...
    captchaRequired: 'Completá la verificación de seguridad e intentá de nuevo.',
    signInWithPassword: 'Ingresar con email y contraseña',
    mobileGateTitle: 'Antes de ingresar',
    mobileGateDesc: 'Activá tu huella o Face ID para entrar con un toque, sin códigos.',
    ...
    activation: {
      pendingTitle: 'Revisá tu correo electrónico para activar tu cuenta',
      pendingDesc:
  ...
  passkey: {
    ...
    registerOnboardingDesc: 'Activá huella o Face ID para ingresar más rápido la próxima vez, como en Mercado Pago.',
    deviceNameFaceId: 'Face ID',
    deviceNameGeneric: 'Huella / biometría',
  ...
  totpVerify: {
    ...
    invalidSessionDesc: 'Volvé al inicio de sesión para intentar de nuevo.',
    goToLogin: 'Ir al login',
    title: 'Verificación de seguridad',
    descBackup: 'Ingresá uno de tus códigos de recuperación.',
    descTotp: 'Abrí Google Authenticator e ingresá el código de 6 dígitos.',
    backupPlaceholder: 'XXXXX-XXXXX',
    verifying: 'Verificando…',
    useBackupCode: 'Usar código de recuperación',
    backToAuthenticatorCode: '← Volver al código del autenticador',
    confirm: 'Confirmar',
    accountLockedMinutes: 'Cuenta bloqueada por {minutes} min por demasiados intentos fallidos.',
    wrongCodeAttempts: 'Código incorrecto. Te quedan {count} intento{plural}.',
    wrongCodeExpired: 'Código incorrecto o expirado.',
    attemptsRemaining: '{count} intento{plural} restante{plural}',
    sessionCreationError: 'Error al crear la sesión. Intentá de nuevo.',
    troubleSigningIn: '¿Problemas para acceder?',
    contactSupport: 'Contactar soporte',
    emailCodeDesc: 'Te enviamos un código de 6 dígitos a {email}.',
    emailCodeDescGeneric: 'Te enviamos un código de 6 dígitos a tu correo.',
    emailCodeResend: 'Enviar el código de nuevo',
    emailCodeResendIn: 'Podés pedir otro código en {seconds}s',
    emailCodeSendFailed: 'No pudimos enviar el código. Probá de nuevo en un momento.'
  },
  authSplash: {
  ...
  pwa: {
    ...
    installDesktopQrHint: 'Escaneá el QR del manifest desde tu celular o abrí sanovacapital.com en Safari/Chrome móvil.',
    ...
    updateAvailableDesc: 'Actualizá para tener las últimas mejoras y correcciones.',
    updateReloadCta: 'Actualizar'
  },
  walletActivation: {
  ...
  morphoLiquidityPanel: {
    ...
    seedButton: 'Sembrar liquidez USDC',
    seeding: 'Sembrando…',
    seedHint:
      'Admin: “Sembrar liquidez USDC” usa el saldo de la wallet Morpho de Sanova (Privy) para ese mercado. Puede tardar 1–3 minutos.',
    seedSuccess: 'Seed Morpho completado (estado: {status}). Actualizá el panel si hace falta.',
    seedError: 'No se pudo sembrar liquidez Morpho: {detail}',
    updated: 'Actualizado',
    refresh: 'Actualizar',
  ...
  paymentGateway: {
    ...
    bridgeBic: 'BIC',
    bridgeClabe: 'CLABE',
    bridgeSortCode: 'Sort code',
    bridgeRails: 'Rails de pago',
    ...
    bridgeSimulatedNotice: 'Cuenta virtual Bridge simulada (solo desarrollo).',
    bridgeKycTitle: 'Completá la verificación Bridge',
    bridgeKycDesc:
      'Antes de generar la cuenta virtual tenés que aceptar los términos de Bridge y completar el KYC (Persona).',
    bridgeKycCta: 'Completar KYC',
    bridgeTosCta: 'Aceptar términos',
    bridgePixQrAlt: 'QR Pix Bridge',
    bridgeCopyPix: 'Copiar código Pix',
    copy: 'Copiar',
    copied: 'Copiado',
  ...
  simplifiedCheckout: {
    ...
    fiatWalletErrorPreparing: 'No pudimos preparar el pago. Intentá nuevamente.',
    fiatWalletPaymentReceivedTitle: '¡Pago recibido!',
    fiatWalletPaymentReceivedBody: 'Estamos confirmando la acreditación en tu cuenta.',
    fiatWalletGeneratingQr: 'Generando tu QR de pago…',
    fiatWalletMpInteroperableBadge: '✓ QR Interoperable — acepta MODO y Mercado Pago',
    fiatWalletAmountPrefilledNote: 'El monto ({amount}) ya está cargado — solo tenés que confirmar el pago en tu billetera.',
    fiatWalletWaitingConfirmation: 'Esperando confirmación del pago…',
    fiatWalletMpInstructions: 'Abrí MODO, Mercado Pago o tu billetera preferida · Escaneá · Apretá Pagar',
    fiatWalletQrNotConfiguredTitle: '⏳ QR Interoperable no configurado aún',
    fiatWalletQrNotConfiguredBodyPrefix: 'Configurá ',
    fiatWalletQrNotConfiguredBodySuffix: ' en el servidor para habilitarlo.',
    fiatWalletPayWithCardMeanwhile: 'Pagar con tarjeta mientras tanto (Transak)',
    fiatWalletGeneratingPix: 'Gerando seu QR Pix…',
    fiatWalletPixBadge: '✓ Pix — aceito por qualquer banco',
    fiatWalletPixAmountNote: 'O valor ({amount}) já está preenchido — só falta confirmar no seu app.',
    fiatWalletPixCopyCode: 'Copiar código Pix (Copia e Cola)',
    fiatWalletPixCodeCopied: 'Código Pix copiado',
    fiatWalletPixNotConfiguredTitle: '⏳ Pix ainda não configurado',
    fiatWalletPixNotConfiguredBody: 'Requer uma conta Mercado Pago Brasil habilitada no servidor.',
    ...
    cryptoWalletWaitingDeposit: 'Esperando USDC en tu wallet Sanova…',
    cryptoWalletAutoSettleWaiting: 'Depósito detectado o en camino · vamos a pagar solos cuando llegue el saldo',
    ...
    cryptoWalletFundFromWalletTitle: 'Cargar desde Coinbase / WalletConnect',
    cryptoWalletFundFromWalletBody:
      'Conectá tu billetera y enviá USDC a tu cuenta Sanova. No paga al treasury: solo fondea tu wallet Sanova.',
    cryptoWalletFundSendButton: 'Enviar {amount} USDC a mi wallet Sanova',
    cryptoWalletFundSending: 'Enviando USDC a tu wallet Sanova…',
    cryptoWalletFundSendError: 'No se pudo enviar USDC a tu wallet Sanova: {error}',
    cryptoWalletWaitingForFunds: 'Esperando que llegue el USDC a tu wallet Sanova…',
    cryptoWalletSwitchToExternalPay: 'Pagar directo con Coinbase / WalletConnect (sin pasar por Sanova)',
    ...
    cryptoWalletPrivyReceiveTitle: 'Tu cuenta Sanova (USDC Base)',
    cryptoWalletPrivyReceivePurchaseHint:
      'Mandá USDC desde Ripio u otra billetera a esta dirección. Cuando llegue, pagamos solos y te acreditamos los tokens.',
    cryptoWalletPrivyReceiveDepositHint:
      'Mandá USDC Base a esta dirección. Tu saldo de cartera se actualiza automáticamente.',
    ...
    cryptoWalletRpcUserPaysUnsupported:
      'El pago con gas en USDC se actualizó. Recargá la página y tocá Pagar de nuevo — tu saldo no se movió.',
    cryptoWalletTransferFailed:
      'No se pudo transferir el USDC desde tu wallet Sanova. Tocá Pagar de nuevo. Si persiste: {error}',
    ...
    cryptoWalletPrivyBalanceLabel: 'Saldo USDC en tu wallet',
    cryptoWalletPrivyPaying: 'Firmando y enviando USDC…',
    cryptoWalletPrivyLoginHint:
      'Todavía no tenemos tu dirección Sanova. Tocá el botón para prepararla (sin un segundo inicio de sesión).',
    cryptoWalletPrepareButton: 'Preparar wallet Sanova',
    cryptoWalletPrivyPreparing: 'Preparando tu wallet Sanova…',
    ...
    cryptoWalletOtherWalletHint:
      'Evitalo si mandás desde Ripio. La forma simple es enviar a TU wallet Sanova (arriba). La treasury es solo para soporte operativo.',
    cryptoWalletOpenExternalWallet: 'Abrir wallet externa (puede mostrar “Abrir con…”)',
    cryptoWalletVerifyNow: 'Ya transferí — verificar ahora',
    cryptoWalletStillWaiting:
      'Aún no vemos el pago en Base. Confirmá monto exacto y red Base, o pagá desde tu wallet Sanova.',
    cryptoWalletScanHint: 'Escaneá con MetaMask, Trust, Coinbase Wallet o cualquier wallet EVM',
    cryptoWalletAmountPrefillNote: 'El monto ({amount} USDC) se pre-llena automáticamente',
    cryptoWalletHideQr: 'Ocultar QR',
    cryptoWalletShowQr: 'Ver QR (para escanear desde otro celular)',
    cryptoWalletQrModeAddress: 'Dirección (Ripio / Lemon / Coinbase)',
    cryptoWalletQrModeEip681: 'Con monto (MetaMask)',
    cryptoWalletQrAddressHint:
      'Escaneá con Ripio, Lemon, Coinbase o MetaMask. Después elegí USDC en red Base y enviá el monto exacto.',
    cryptoWalletQrEip681Hint:
      'Algunas wallets (p. ej. MetaMask) abren la transferencia USDC con monto. Ripio y Lemon suelen no leer este formato.',
    cryptoWalletAmountPrefilledShort: 'Monto pre-llenado: {amount} USDC · Base',
    cryptoWalletCopyAddressTitle: 'Copiar dirección',
    cryptoWalletCopyUri: 'Copiar URI de pago (EIP-681)',
    cryptoWalletUriCopied: 'URI de pago copiada',
    cryptoWalletUsePayNowHint: 'Usá el pago desde wallet Sanova (arriba). Las apps externas son opcionales.',
    cryptoWalletQrAlt: 'QR pago {amount} USDC',
    ripioMethod: 'Ripio (ARS → USDC)',
    ripioPanelTitle: 'Pagar con Ripio',
    ripioPanelHint: 'Ripio convierte ARS a USDC en Base y completa el pago automáticamente.',
    ripioOpenCheckout: 'Continuar en Ripio',
    ripioNotConfigured: 'Ripio no está configurado en este entorno.',
    ripioPreparing: 'Preparando checkout Ripio…',
    wireTotalToPay: 'Total a pagar',
    wireReceiveNote: 'Recibirás {amount} USDC en tu cuenta',
    wireScanToStart: 'Escaneá con el celular para iniciar la transferencia',
    wireOpenInBrowser: 'Abrir en el navegador',
    wireStartTransferMobile: 'Iniciar transferencia bancaria — Transak',
    wireQrAlt: 'QR Transak — transferencia bancaria',
    feeBreakdown: {
    ...
    settlementFiatPaid: 'Pago recibido. Convirtiendo a USDC en Base…',
    settlementAwaitingUsdc: 'Esperando USDC en tesorería Base…',
    settlementConfirmed: 'Depósito confirmado.',
    settlementRwaDelivered: 'Tokens RWA entregados a tu wallet.',
    settlementFailed: 'No pudimos completar la liquidación. Contactá soporte.',
    wireBankInstructionsTitle: 'Instrucciones bancarias',
    wireAwaitingSettlement: 'Cuando llegue la transferencia, acreditamos USDC y entregamos tus RWA automáticamente.',
    fiatWalletPayNowCta: 'Pagar {amount}',
    fiatWalletQrBackup: 'O escaneá el QR',
  ...
  pwaHome: {
    ...
    cartFabAria: 'Abrir carrito e invertir',
    cartNavLabel: 'Carrito',
    profileNavLabel: 'Perfil',
    profileAccountTitle: 'Tu cuenta',
    profileIdentityLabel: 'Verificación de identidad',
    profileActivationPending: 'Activación pendiente',
    profileAccountPendingHint:
      'Completá la verificación de identidad para depositar, retirar e invertir.',
    profileContinueVerification: 'Continuar verificación',
    profileSecurityTitle: 'Seguridad',
    profileSecuritySubtitle: 'Biometría, autenticador y cierre de sesión.',
