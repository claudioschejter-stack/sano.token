...
export const ur = {
  ...
  marketplace: {
    ...
    allBorrowRatesDesc: "Comparativa de tasas de préstamo contra colateral RWA en protocolos DeFi e institucionales de todo el mundo.",
    colLender: "Prestamista",
    colRegion: "Región",
    colCategory: "Tipo",
    colBorrowRate: "Tasa APY",
    bestBadge: "Mejor",
    lendingRatesFootnote: "Tasas indicativas en APY. Configurables por entorno; conectá APIs on-chain para datos en tiempo real.",
    lenderRegions: {
      global: "Global",
      americas: "Américas",
      europe: "Europa",
  ...
  adminLaunch: {
    ...
    uploadStorageNotConfigured: "Almacenamiento no configurado en Vercel. Agregá SUPABASE_KEY (service role) y el bucket launches en Supabase.",
