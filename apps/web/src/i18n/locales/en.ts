export const en = {
  ...
  simplifiedCheckout: {
    ...
    cryptoWalletPaymentReceivedBody: "We automatically detected your transfer on Base.",
    ...
    cryptoWalletInsufficientPrivy:
      "Not enough USDC in your Sanova wallet. Send USDC on Base to your Privy address above (not the treasury), then pay again.",
    cryptoWalletPrivyPayError: "Could not pay with Privy: {error}",
    cryptoWalletOtherWalletTitle: "Other wallet / external transfer (advanced)",
    cryptoWalletOtherWalletHint:
      "Only if you already use MetaMask or another app. If sending from Ripio/exchange, send to YOUR Sanova (Privy) wallet — don’t copy the treasury unless you follow the exact watch amount.",
