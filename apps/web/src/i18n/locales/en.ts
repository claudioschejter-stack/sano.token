export const en = {
  ...
  cartCheckout: {
    ...
    depositSubtitle: "Add balance to your Sanova wallet using the same automatic payment options.",
  ...
  onboarding: {
    ...
    steps: {
      ...
      phoneDescWhatsapp: "Enter the 6-digit code we sent via WhatsApp.",
      phoneDescSms: "Enter the 6-digit SMS code.",
      codeSentEmail: "We send a code to your email.Check your inbox and spam.",
      codeSentPhoneWhatsapp: "We sent a code via WhatsApp to your phone.",
      codeSentPhoneSms: "We send a code by SMS to your phone.",
