export const en = {
  meta: {
    ...
    keywords:
      "Vaca Muerta tokenization, Token Vaca Muerta, RWA tokens Argentina, Sanova, Sanova Global, Sanova RWA, Sanova Capital, tokenized real estate USDC, real estate tokenizado Argentina, RWA investment Vaca Muerta, Añelo investment, Añelo real estate, Neuquén real estate investment, Argentina shale investment, USDC yield real estate, Vaca Muerta yield, RWA profitability, rental income USDC, ERC-4626 real estate tokens, DeFi real estate Argentina, Morpho RWA collateral, tokenization real assets, private placement Argentina, USDC dividends, shale infrastructure tokens",
    ogImageAlt: "Sanova Global — Tokenized Real Estate in Vaca Muerta, Argentina",
    pwaTitle: "Sanova RWA"
  },
  legalPagesMeta: {
    termsTitle: "Legal Terms | Sanova Global",
    termsDescription:
      "Legal Terms and Conditions of Use of Sanova Global SAS. Sanova Global RWA Trust, Compartments, private placement, whitelist, international assets, and ERC-4626 vaults (Base).",
    privacyTitle: "Privacy Policy | Sanova Global",
    privacyDescription:
      "Privacy Policy of Sanova Global SAS. Sanova Global RWA Trust, Compartments, KYC/AML, data protection law, and Web3 data handling.",
    totpVerifyTitle: "Security verification — Sanova Capital",
    securityTitle: "Security — Sanova Capital",
    securityDescription: "Set up two-factor authentication (2FA) to protect your account."
  },
  brand: {
  ...
  adminSettings: {
    ...
    integrationSetupHints: {
      ...
      kyc: "Didit API credentials and webhook secret. The KYC workflow ID is defined in code, not in environment variables.",
  ...
  adminWithdrawals: {
    eyebrow: "Withdrawal fulfillment",
    title: "Withdrawals",
    subtitle:
      "Investor cash withdrawals debit the internal balance immediately. For USDC, send from the treasury Safe and confirm with the tx hash. For ARS/fiat, execute the bank transfer and confirm with the transfer reference — or reject to refund the balance.",
    loading: "Loading withdrawals…",
    error: "Withdrawals could not be loaded.",
    refresh: "Refresh",
    kpiPending: "Pending amount",
    kpiPendingHint: "{count} request(s) awaiting fulfillment",
    kpiOldest: "Oldest pending request",
    kpiOldestHint: "Time waiting for fulfillment",
    filters: {
      ALL: "All",
      PENDING: "Pending",
    ...
    colStatus: "Status",
    colActions: "Actions",
    emptyState: "There are no withdrawals with this filter.",
    ...
    rejectFormTitle: "Reject withdrawal",
    rejectFormHint: "The balance will be credited back to the investor automatically.",
    reasonPlaceholder: "Reason (shown to the investor)",
    rejectSubmit: "Reject and refund balance",
    rejectSubmitting: "Rejecting…",
    verificationOk: "On-chain transfer verified ({confirmations} confirmation(s)).",
    verificationWarning: "Could not verify the transfer on-chain ({reason}). Double-check the tx hash before trusting this confirmation.",
  ...
  linkedWallets: {
    title: "My wallets",
    subtitle: "Crypto wallets and digital wallets you've used to pay or get paid on Sanova.",
    cryptoSection: "Crypto wallets (USDC on Base)",
    fiatSection: "Digital wallets (cash)",
    bridgeSection: "Bank accounts (Bridge)",
    bridgeProvider: "Bridge",
    bridgeAddCta: "Link a bank account (USD / EUR / MXN)",
    bridgeLinkTitle: "Link bank account via Bridge",
    bridgeLinkDesc:
      "Add your US (ACH), EU (IBAN), or Mexico (CLABE) account for fiat withdrawals. Sanova still reviews payouts manually.",
    bridgeCurrency: "Currency",
    bridgeBankName: "Bank name",
    bridgeAccountName: "Account nickname",
    bridgeFirstName: "First name",
    bridgeLastName: "Last name",
    bridgeOwnerName: "Account owner name (optional)",
    bridgeRouting: "Routing number",
    bridgeAccountNumber: "Account number",
    bridgeIbanCountry: "IBAN country (ISO)",
    bridgeStreet: "Street address",
    bridgeCity: "City",
    bridgeState: "State / province",
    bridgePostal: "Postal code",
    bridgeCountry: "Country (ISO)",
    bridgeLinkCta: "Save bank account",
    bridgeLinking: "Saving…",
    bridgeLinkError: "Could not link this bank account. Check the details and try again.",
    bridgeKycRequired: "Complete Bridge KYC and Terms of Service before linking a bank account.",
    bridgeKycCta: "Continue KYC",
    bridgeTosCta: "Accept Terms",
    defaultBadge: "Active",
    useThisWallet: "Use this wallet",
    switching: "Activating…",
    hint: "When withdrawing, you'll be able to choose which of these wallets receives your sale proceeds."
  },
  platformWallet: {
    ...
    tabHistory: "History",
    depositTitle: "Deposit funds",
    depositSubtitle: "Send USDC on Base to your Sanova wallet. Your balance updates automatically.",
    receiveUsdcTitle: "Receive USDC (Base)",
    receiveUsdcSubtitle:
    ...
    receiveUsdcCopied: "Address copied",
    receiveUsdcNoWallet: "We are preparing your Sanova wallet. Refresh in a few seconds.",
    receiveUsdcNetwork: "Network: Base · Token: USDC",
    receiveUsdcInvestCta: "Invest with this balance",
    withdrawTitle: "Withdraw funds",
    withdrawSubtitle: "USDC to your connected wallet or fiat withdrawal with treasury review.",
    withdrawAutoSubtitle:
      "Choose whether to withdraw USDC to a linked crypto wallet or ARS via bank/digital wallet with treasury review.",
    withdrawAutoRunning: "Sending withdrawal request…",
    withdrawAutoHint: "Once confirmed, we reserve the balance and process the transfer to your destination.",
    withdrawModeCrypto: "USDC to my wallet",
    withdrawModeFiat: "Pesos (transfer)",
    withdrawSubmitCrypto: "Withdraw USDC now",
    withdrawSubmitFiat: "Request ARS withdrawal",
    fiatChipsLabel: "Wallets you've already used to pay",
    fiatChipNoteTemplate: "Account previously used to pay: {identifier}",
    fiatRailBank: "Bank / CBU-CVU",
    fiatRailOther: "Other method",
    fiatAccountHolder: "Account holder",
    fiatTaxId: "CUIT / DNI",
    fiatCbuCvu: "CBU / CVU",
    fiatAlias: "Alias",
    fiatProviderName: "Wallet / bank (optional)",
    fiatNotes: "Tell us how to receive the payment",
    fiatManualHint:
      "A Sanova admin reviews and executes the transfer manually; you'll get an email when it's confirmed.",
    fiatFormIncomplete: "Complete the required fields to request an ARS withdrawal.",
  ...
  onboarding: {
    ...
    errors: {
      ...
      DIDIT_WORKFLOW_NOT_FOUND:
        'The configured KYC workflow was not found. Contact support to review the Didit integration.',
      DIDIT_QUOTA_EXCEEDED:
        'Didit could not create the session: free monthly quota used up (500/month) or the workflow includes paid modules (e.g. AML). Check usage at business.didit.me.',
  ...
  passkey: {
    ...
    registerOnboardingDesc: "Enable fingerprint or Face ID to sign in faster next time, just like Mercado Pago.",
    deviceNameFaceId: "Face ID",
    deviceNameGeneric: "Fingerprint / biometrics",
  ...
  totpVerify: {
    ...
    invalidSessionDesc: "Return to sign-in to try again.",
    goToLogin: "Go to sign-in",
    title: "Security verification",
    descBackup: "Enter one of your recovery codes.",
    descTotp: "Open Google Authenticator and enter the 6-digit code.",
    backupPlaceholder: "XXXXX-XXXXX",
    verifying: "Verifying…",
    useBackupCode: "Use recovery code",
    backToAuthenticatorCode: "← Back to authenticator code",
    confirm: "Confirm",
    accountLockedMinutes: "Account locked for {minutes} min due to too many failed attempts.",
    wrongCodeAttempts: "Wrong code. You have {count} attempt{plural} left.",
    wrongCodeExpired: "Wrong or expired code.",
  ...
  paymentGateway: {
    ...
    bridgeSimulatedNotice: "Simulated Bridge virtual account (development only).",
    bridgeKycTitle: "Complete Bridge verification",
    bridgeKycDesc:
      "Before we can issue a virtual account you must accept Bridge terms and finish KYC (Persona).",
    bridgeKycCta: "Complete KYC",
    bridgeTosCta: "Accept terms",
    bridgePixQrAlt: "Bridge Pix QR",
    bridgeCopyPix: "Copy Pix code",
    copy: "Copy",
    copied: "Copied",
  ...
  simplifiedCheckout: {
    ...
    fiatWalletErrorPreparing: "We couldn't prepare the payment. Please try again.",
    fiatWalletPaymentReceivedTitle: "Payment received!",
    fiatWalletPaymentReceivedBody: "We're confirming the deposit to your account.",
    fiatWalletGeneratingQr: "Generating your payment QR…",
    fiatWalletMpInteroperableBadge: "✓ Interoperable QR — accepts MODO and Mercado Pago",
    fiatWalletAmountPrefilledNote: "The amount ({amount}) is already loaded — just confirm the payment in your wallet.",
    fiatWalletWaitingConfirmation: "Waiting for payment confirmation…",
    fiatWalletMpInstructions: "Open MODO, Mercado Pago or your preferred wallet · Scan · Tap Pay",
    fiatWalletQrNotConfiguredTitle: "⏳ Interoperable QR not yet configured",
    fiatWalletQrNotConfiguredBodyPrefix: "Configure ",
    fiatWalletQrNotConfiguredBodySuffix: " on the server to enable it.",
    fiatWalletPayWithCardMeanwhile: "Pay by card meanwhile (Transak)",
    fiatWalletGeneratingPix: "Generating your Pix QR…",
    fiatWalletPixBadge: "✓ Pix — accepted by any bank",
    fiatWalletPixAmountNote: "The amount ({amount}) is already filled in — just confirm it in your app.",
    fiatWalletPixCopyCode: "Copy Pix code (Copy & Paste)",
    fiatWalletPixCodeCopied: "Pix code copied",
    fiatWalletPixNotConfiguredTitle: "⏳ Pix not yet configured",
    fiatWalletPixNotConfiguredBody: "Requires an enabled Mercado Pago Brazil account on the server.",
    fiatWalletScanToPay: "Scan with your digital wallet to pay",
    ...
    cryptoWalletDepositReceivedBody: "Your USDC balance in the Sanova wallet is now available.",
    cryptoWalletWaitingPayment: "Waiting for your payment · confirms automatically, no need to paste the hash",
    cryptoWalletWaitingDeposit: "Waiting for USDC in your Sanova wallet…",
    cryptoWalletAutoSettleWaiting: "Deposit detected or on the way · we will pay automatically when balance arrives",
    ...
    cryptoWalletPrivyReceiveTitle: "Your Sanova account (USDC Base)",
    ...
    cryptoWalletManualReview:
      "Your purchase is in manual review. Sanova will contact you — no need to pay again.",
    ...
    cryptoWalletOtherWalletHint:
      "Avoid this if you send from Ripio. The simple path is sending to YOUR Sanova wallet (above). Treasury is for ops support only.",
    cryptoWalletOpenExternalWallet: "Open external wallet (may show “Open with…”)",
    cryptoWalletVerifyNow: "I already transferred — verify now",
    cryptoWalletStillWaiting:
      "We still don’t see the payment on Base. Check exact amount and Base network, or pay from your Sanova wallet.",
    cryptoWalletScanHint: "Scan with MetaMask, Trust, Coinbase Wallet or any EVM wallet",
    ...
    cryptoWalletUriCopied: "Payment URI copied",
    cryptoWalletUsePayNowHint: "Use Sanova wallet payment above. External apps are optional.",
    cryptoWalletQrAlt: "QR payment {amount} USDC",
    ripioMethod: "Ripio (ARS → USDC)",
    ripioPanelTitle: "Pay with Ripio",
    ripioPanelHint: "Ripio converts ARS to USDC on Base and completes payment automatically.",
    ripioOpenCheckout: "Continue with Ripio",
    ripioNotConfigured: "Ripio is not configured in this environment.",
    ripioPreparing: "Preparing Ripio checkout…",
    wireTotalToPay: "Total to pay",
    wireReceiveNote: "You will receive {amount} USDC in your account",
    wireScanToStart: "Scan with your phone to start the transfer",
    wireOpenInBrowser: "Open in browser",
    wireStartTransferMobile: "Start bank transfer — Transak",
    wireQrAlt: "Transak QR — bank transfer",
    feeBreakdown: {
      ...
      chargedByPrefix: 'Charged by:',
      chargedBySanova: 'Sanova (asset / deposit)',
      chargedByGateway: 'Payment gateway',
      chargedByBase: 'Base network',
      chargedByUserPaysUsdc: 'Base · deducted from your USDC',
      chargedByFx: 'FX / on-ramp'
    },
    settlementAwaitingPayment: 'Waiting for your payment…',
    settlementFiatPaid: 'Payment received. Converting to USDC on Base…',
    settlementAwaitingUsdc: 'Waiting for USDC in Base treasury…',
    settlementConfirmed: 'Deposit confirmed.',
    settlementRwaDelivered: 'RWA tokens delivered to your wallet.',
    settlementFailed: 'We could not complete settlement. Please contact support.',
    wireBankInstructionsTitle: 'Bank transfer instructions',
    wireAwaitingSettlement: 'When the transfer arrives, we credit USDC and deliver your RWA automatically.',
    fiatWalletPayNowCta: 'Pay {amount}',
    fiatWalletQrBackup: 'Or scan the QR',
  ...
  pwaHome: {
    ...
    cartFabAria: "Open cart and invest",
    cartNavLabel: "Cart",
    profileNavLabel: "Profile",
    profileAccountTitle: "Your account",
    profileIdentityLabel: "Identity verification",
    profileActivationPending: "Activation pending",
    profileAccountPendingHint:
      "Complete identity verification to deposit, withdraw, and invest.",
    profileContinueVerification: "Continue verification",
    profileSecurityTitle: "Security",
    profileSecuritySubtitle: "Biometrics, authenticator, and sign out.",
    comingSoonTitle: "Coming soon",
    comingSoonBody: "We're preparing this section. You'll be able to see it here very soon.",
    backToPanel: "Back to panel",
    depositAction: "Deposit",
    withdrawAction: "Withdraw",
    marketplaceAction: "Properties",
