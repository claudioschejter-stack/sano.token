export const en = {
  ...
  adminWithdrawals: {
    ...
    title: "Withdrawals",
    subtitle:
      "Investor cash withdrawals debit the internal balance immediately. Send the USDC from the treasury Safe outside this app, then confirm here with the resulting tx hash — or reject to refund the balance.",
  ...
  platformWallet: {
    ...
    withdrawAutoSubtitle:
      "Your withdrawal request is deducted from your balance and goes into review; our team sends the USDC to your linked wallet within the next few hours.",
    withdrawAutoRunning: "Sending withdrawal request…",
    withdrawAutoHint: "Once confirmed, we reserve the balance and process the USDC transfer to your wallet.",
