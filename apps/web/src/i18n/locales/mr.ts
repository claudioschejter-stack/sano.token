...
export const mr = mergeLocale({
  ...
  landing: {
    ...
    hero: {
      ...
      subtitle:
        'Sanova Global सत्यापित गुंतवणूकदारांना वाका मुएर्ता, न्यूक्वेन, अर्जेंटिनामधील उत्पादक मालमत्तांशी जोडते — जागतिक अनपारंपारिक शेल ऑइल आणि गॅस केंद्र, जगातील दुसऱ्या क्रमांकाचा गॅस साठा, जागतिक दर्जाची पायाभूत सुविधा, स्पर्धात्मक ऑपरेटिंग खर्च आणि मोठी तेल-गॅस उत्पादन क्षमता — पारदर्शक परतावा, KYC अनुपालन आणि त्वरित सेटलमेंटसह.',
