...
import { ArrowLeft, ExternalLink, Pencil, RefreshCw, Save, Trash2, X } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <header className="border-b border-terminal-border pb-6">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-terminal-primary">
            {t.adminLoans.eyebrow}
          </p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-terminal-text">{t.adminNav.loans}</h1>
          <p className="mt-3 max-w-3xl text-terminal-muted">{t.adminLoans.subtitle}</p>
        </header>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex flex-wrap gap-2">
                              <Link
                                ...
                                className="inline-flex items-center gap-1 rounded-lg border border-terminal-primary/40 px-2.5 py-1.5 text-xs font-semibold text-terminal-primary transition-colors hover:bg-terminal-primary/10"
                              >
                                <Pencil size={14} />
                                {t.adminLoans.configureLoan}
                              </Link>
                              <Link
