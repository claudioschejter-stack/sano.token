...
export const metadata: Metadata = {
  ...
  description:
    'Términos Legales y Condiciones de Uso de Sanova Global SAS. Fideicomiso Máster, bóvedas ERC-4626, colocación privada CNV, KYC/AML y liquidaciones en USDC (Base).',
  alternates: {
